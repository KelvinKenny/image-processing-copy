...
[(clique aqui para ver o meu perfil na plataforma)](https://web.dio.me/users/kekezim123)
#### Tecnologia: Python
#### Data: 22/08/2020
-----------------------------------------
### Descrição
...
```
<img width="auto" src="https://github.com/KelvinKenny/image-processing-package/blob/master/image-processing-test.png?raw=true">

## Autor (quem hospedou o projeto no Test Pypi)
Kelvin Kennedy Santos Souza
